...
import { Sprout, LogIn, LogOut, Database, HelpCircle } from 'lucide-react';
  ...
  return (
    <header className="bg-slate-900 border-b border-white/[0.08] sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-wrap items-center justify-between gap-4">
        ...
        >
          <div className="p-2 sm:p-2.5 bg-emerald-500/10 rounded-xl border border-emerald-500/30 text-emerald-400">
